...
import kr.co.tjoeun.pizzastore_20200714.OrderDetailActivity
...
class OrderFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        orderListView.setOnItemClickListener { parent, view, position, id ->
            ...
            val clickedStore = mOrderList[position]
//                데이터를 전달
            val myIntent = Intent(activity, OrderDetailActivity::class.java)
